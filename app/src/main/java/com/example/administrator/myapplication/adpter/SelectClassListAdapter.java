...
public class SelectClassListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<GetRecommendClassListDataBean.OrderMainBean> list = new ArrayList<>();
    private SelectClassListActivity activity;
    public OnItemClick onItemClick;
    public SelectClassListAdapter(SelectClassListActivity activity) {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, final int i) {
        ...
        Glide.with(activity).load(AppConfig.ImgUrl + list.get(i).getF0020()).into(((MyViewHolder) viewHolder).img);
